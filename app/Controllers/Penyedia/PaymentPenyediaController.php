...
class PaymentPenyediaController extends BaseController
{
    public function index($orderId)
    {
        ...
        $transaction = [
            ...
            'finish_redirect_url' => base_url('penyedia/payment/update-status'),
        ];
        ...
        return view('pages/penyedia/payment/payment', $data);
    }
    ...
    public function updateStatus($orderId)
    {
        ...
        return redirect()->to(base_url('penyedia/detail'))->with('success', 'Pembayaran berhasil!');
    }
}
