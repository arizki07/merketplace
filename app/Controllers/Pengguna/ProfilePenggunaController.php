...
class ProfilePenggunaController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('pages/pengguna/profile/index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('pages/pengguna/profile/add-profile', $data);
    }
    ...
    public function store()
    {
        ...
        return redirect()->to(site_url('/pengguna/profile'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages/pengguna/profile/edit-profile', $data);
    }
