                        ...
                        <form id="formAuthentication" class="mb-3" action="<?= base_url('register') ?>" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-check-inline mt-3">
                                    <input class="form-check-input" type="radio" name="role" id="inlineRadio1" value="Pengguna" />
                                    <label class="form-check-label" for="inlineRadio1">Pengguna Jasa</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="role" id="inlineRadio2" value="Penyedia" />
