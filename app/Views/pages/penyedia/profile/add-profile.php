...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
                <div class="card-body">
                    <form method="post" action="<?= site_url('penyedia/profile/store') ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="no_telepon" id="basic-default-phone"
                                class="form-control phone-mask" placeholder="658 799 8941" required />
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="alamat" id="basic-default-message" class="form-control"
                                placeholder="Isi alamat sesuai KTP" required></textarea>
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" name="nomor_ktp" class="form-control" id="basic-default-company"
                                placeholder="Isi Nomer KTP" required />
                        </div>
                        <div class="mb-3">
