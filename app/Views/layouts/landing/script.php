<script src="<?= base_url() ?>landing/js/vendor/jquery-2.2.4.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js" integrity="sha384-b/U6ypiBEHpOf/4+1nzFpr53nxSS+GLCkfwBdFNTxtclqqenISfwAzpKaMNFNmj4" crossorigin="anonymous"></script>
<script src="<?= base_url() ?>landing/js/vendor/bootstrap.min.js"></script>
<script src="<?= base_url() ?>landing/js/jquery.ajaxchimp.min.js"></script>
...
<script src="<?= base_url() ?>landing/js/gmaps.min.js"></script>
